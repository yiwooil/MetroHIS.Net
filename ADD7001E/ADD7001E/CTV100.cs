...
namespace ADD7001E
{
    class CTV100
    {
        // ADD7000E에 있는 CDataTV100에서 복사해옴.
        ...
        public void SetData(string p_pid, string p_bdedt)
        {
            try
            {
                ...
                sql += System.Environment.NewLine + "     , A09OUT.INSDPTCD INSDPTCD_OUT";  /* 퇴과(보험분류과) */
                ...
                sql += System.Environment.NewLine + " WHERE V100.PID =	'" + p_pid + "'";
                sql += System.Environment.NewLine + "   AND V100.BEDEDT = '" + p_bdedt + "'";
                ...
                using (OleDbConnection conn = new OleDbConnection(strConn))
                {
                    ...
                    ReadTV100TR(conn, p_pid, p_bdedt);
                    ReadTV100OP(conn, p_pid, p_bdedt);
                    ReadTV100DX(conn, p_pid, p_bdedt);
                    ReadTV100DEDX(conn, p_pid, p_bdedt);
                    ReadTV100DCOR(conn, p_pid, p_bdedt);
                    ReadTV100GUM(conn, p_pid, p_bdedt);
                }
            }
            catch (Exception ex)
            {
        ...
        private void ReadTV100TR(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
        ...
        private void ReadTV100OP(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
        ...
        private void ReadTV100DX(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
            ...
            sql += System.Environment.NewLine + " WHERE DX.PID =	'" + p_pid + "'";
            sql += System.Environment.NewLine + "   AND DX.BEDEDT = '" + p_bdedt + "'";
            ...
            while (reader.Read())
            {
                ...
                DX_INSDPTCD.Add(reader["INSDPTCD"].ToString());
                DX_POA.Add(strPoaCd);
            }
            reader.Close();
        }

        private void ReadTV100DEDX(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
        ...
        private void ReadTV100DCOR(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
        ...
        private void ReadTV100GUM(OleDbConnection p_conn, string p_pid, string p_bdedt)
        {
            String sql = "";
        ...
        private void SetInsdptcd(OleDbConnection p_conn)
        {
            ...
            String sql = "";
            sql = "SELECT * FROM TA09 WHERE DPTDIV='1'";
            // TSQL문장과 Connection 객체를 지정   
            OleDbCommand cmd = new OleDbCommand(sql, p_conn);
            ...
            while (reader.Read())
            {
                m_Dptcd.Add(reader["DPTCD"].ToString(), reader["INSDPTCD"].ToString());
            }
            reader.Close();
        }
    }
