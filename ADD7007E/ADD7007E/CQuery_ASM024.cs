...
namespace ADD7007E
{
    class CQuery_ASM024 : CQuery
    {
        public List<CDataASM024_002> Query_ASM024(OleDbConnection conn, string frdt, string todt)
        {
            m_dic_cnectdd.Clear();
            m_dic_dcount.Clear();
            m_dic_billsno.Clear();
            ...
            List<CDataASM024_002> list = new List<CDataASM024_002>();
        ...
        private bool Check_ASM024(DataRow p_row, OleDbConnection p_conn)
        {
            System.Windows.Forms.Application.DoEvents();
            return true;
        }
