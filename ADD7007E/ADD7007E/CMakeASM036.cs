...
namespace ADD7007E
{
    class CMakeASM036
    {
        public void MakeASM036(CDataASM036_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran, bool re_query)
        {
        ...
        private void SetData(CDataASM036_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran)
        {
