...
namespace ADD7007E
{
    class CMakeASM003
    {
        public void MakeASM003(CDataASM003_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran, bool re_query)
        {
        ...
        private void SetData(CDataASM003_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran)
        {
