...
namespace ADD7007E
{
    ...
    {
        // 
        public void MakeASM002(CDataASM002_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran, bool re_query)
        {
        ...
        private void SetData(CDataASM002_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran)
        {
