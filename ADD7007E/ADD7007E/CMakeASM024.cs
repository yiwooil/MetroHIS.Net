...
namespace ADD7007E
{
    class CMakeASM024
    {
        public void MakeASM024(CDataASM024_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran, bool re_query)
        {
        ...
        private void SetData(CDataASM024_002 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran)
        {
