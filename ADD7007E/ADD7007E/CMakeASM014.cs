...
namespace ADD7007E
{
    class CMakeASM014
    {
        public void MakeASM014(CDataASM014_001 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran, bool re_query)
        {
        ...
        private void SetData(CDataASM014_001 data, string p_sysdt, string p_systm, string p_user, OleDbConnection p_conn, OleDbTransaction p_tran)
        {
