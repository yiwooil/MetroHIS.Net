...
namespace ADD0107E
{
    public partial class ADD0107E : Form
    {
        ...
        public ADD0107E(String user, String pwd, String prjcd)
            : this()
        {
            m_User = user;
            m_Pwd = pwd;
        ...
        private void ADD0107E_Load(object sender, EventArgs e)
        {
            IsFirst = true;
        }

        private void ADD0107E_Activated(object sender, EventArgs e)
        {
        ...
        private void Query()
        {
            ...
            sql = sql + Environment.NewLine + "     , A.EXDATE BDODT";
            sql = sql + Environment.NewLine + "     , A.QFYCD";
            sql = sql + Environment.NewLine + "     , A.JRBY";
            sql = sql + Environment.NewLine + "     , A.PID";
            sql = sql + Environment.NewLine + "     , A.UNISQ";
            sql = sql + Environment.NewLine + "     , A.SIMCS";
            sql = sql + Environment.NewLine + "  FROM TI1A A";
            sql = sql + Environment.NewLine + " WHERE A.EXDATE LIKE '" + yymm + "%'";
            ...
            sql = sql + Environment.NewLine + " ORDER BY A.EXDATE,A.QFYCD,A.SIMNO ";
        ...
        private void grdMainView_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                txtAfterBdodt.Text = DateDayLast(bdodt);
