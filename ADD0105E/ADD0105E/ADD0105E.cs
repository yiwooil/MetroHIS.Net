...
namespace ADD0105E
{
    public partial class ADD0105E : Form
    {
        ...
        public ADD0105E(String user, String pwd, String prjcd)
            : this()
        {
            m_User = user;
            m_Pwd = pwd;
        ...
        private void ADD0105E_Load(object sender, EventArgs e)
        {
            IsFirst = true;
        }

        private void ADD0105E_Activated(object sender, EventArgs e)
        {
