...
namespace ADD0715E
{
    public partial class ADD0715E_01 : Form
    {
        public bool m_sel;
        ...
        private void ADD0715E_01_Load(object sender, EventArgs e)
        {
            IsFirst = true;
            m_sel = false;
        }

        private void ADD0715E_01_Activated(object sender, EventArgs e)
        {
        ...
        private void Query()
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(strConn))
            {
                ...
                string sql = "";
                sql = "SELECT * FROM TIE_F1101 ORDER BY DEMNO DESC";
