...
{
    public partial class ADD0715E_JABO_01 : Form
    {
        public bool m_sel;
        ...
        public ADD0715E_JABO_01()
        {
            InitializeComponent();
        }

        private void ADD0715E_JABO_01_Load(object sender, EventArgs e)
        {
            IsFirst = true;
            m_sel = false;
        }

        private void ADD0715E_JABO_01_Activated(object sender, EventArgs e)
        {
        ...
        private void Query()
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(strConn))
            {
                ...
                string sql = "";
                sql = "SELECT * FROM TIE_N1101 ORDER BY DEMNO DESC";
