...
namespace MetroLib
{
    ...
    {
        public static void CheckSubModuleAndDown()
        {
            try
            {
                // 개발자모드이면 검사하지 않는다.
                String strDevelop = "";
                strDevelop = INIHelper.ReadIniFile("C:/METROSOFT.ini", "MetroHIS", "DEVELOP");
                ...
                subFormid.Add("Microsoft.Office.Interop.Excel.dll");
                subFormid.Add("Microsoft.VisualBasic.dll");
                subFormid.Add("Microsoft.VisualBasic.PowerPacks.Vs.dll");

                subFormid.Add("Newtonsoft.Json.dll");

                subFormid.Add("NPOI.dll");
                subFormid.Add("NPOI.OOXML.dll");
                subFormid.Add("NPOI.OpenXml4Net.dll");
                subFormid.Add("NPOI.OpenXmlFormats.dll");

                subFormid.Add("ICSharpCode.SharpZipLib.dll");
