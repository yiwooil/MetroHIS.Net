...
namespace ADD8003Q
{
    static class Program
    {
        ...
        static void Main(String[] args)
        {
            ...
            if (args.Length > 0)
            {
                ParseArg(args[0], ref user, ref pwd, ref prjcd, ref accno, ref cntno);
            }

            Application.EnableVisualStyles();
            Application.SetCompatibleTextRenderingDefault(false);
            Application.Run(new ADD8003Q(user, pwd, prjcd, accno, cntno));
        }

        private static void ParseArg(String arg, ref String user, ref String pwd, ref String prjcd, ref String accno, ref String cntno)
        {
            ...
            for (int i = 0; i < aryArg.Length; i++)
            {
                ...
                else if ("ACCNO".Equals(val[0].ToUpper())) accno = val[1];
