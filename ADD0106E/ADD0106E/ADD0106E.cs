...
namespace ADD0106E
{
    public partial class ADD0106E : Form
    {
        ...
        public ADD0106E(String user, String pwd, String prjcd)
            : this()
        {
            m_User = user;
            m_Pwd = pwd;
        ...
        private void ADD0106E_Load(object sender, EventArgs e)
        {
            IsFirst = true;
        }

        private void ADD0106E_Activated(object sender, EventArgs e)
        {
