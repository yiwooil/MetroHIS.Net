...
namespace ADD0731E
{
    public partial class ADD0731E_01 : Form
    {
        public bool m_sel;
        ...
        private void ADD0731E_01_Load(object sender, EventArgs e)
        {
            IsFirst = true;
            m_sel = false;
        }

        private void ADD0731E_01_Activated(object sender, EventArgs e)
        {
        ...
        private void Query()
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(strConn))
            {
                ...
                string sql = "";
                sql = "SELECT * FROM TIE_C1001 ORDER BY DEMNO DESC";
