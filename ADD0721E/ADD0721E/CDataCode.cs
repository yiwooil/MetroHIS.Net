...
namespace ADD0721E
{
    class CDataCode
    {
        ...
        public string SKJJRMK2 { get; set; } // 이전심결사항-조정사유사세
        ...
        public double SKDDAY { get; set; } // 이전심결사항-총투 인정횟수
        ...
        public string SKJJREMARK
        {
            get
            {
                string ret = SKJJRMK + SKJJRMK2;
                return ret;
            }
        }
        public string JSJJREMARK
        {
            get
            {
                string ret = JSJJRMK + JSJJRMK2;
                return ret;
            }
        }
